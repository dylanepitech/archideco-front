        ...
        <div className="bg-slate-100 rounded-lg border border-zinc-200 max-w-xs w-full h-full flex flex-col">
            <Link to={`/product/${product?.categoryTitle}/${title}/${product?.id}`}>
                ...
                <div className="px-4 flex-1">
                    ...
                    <p className="text-sm text-zinc-700 truncate">{product?.categoryTitle}</p>
                    <div className="flex items-center mt-2">
                        <span className="bg-green-500 text-white text-xs font-bold uppercase px-2 py-1 rounded">A</span>
                    ...
                    <div className="mt-2">
                        ...
                        <span className="bg-red-500 text-white text-xs font-bold uppercase px-2 rounded mt-2 inline-block">BON PLAN -25%</span>
                    </div>
                </div>
            </Link>
            <div className="p-4">
